...
TabDictionaryNew::TabDictionaryNew(AppConfig &config, qbv::DatabaseService &databaseService, QWidget *parent)
{

}

void TabDictionaryNew::ConnectSignals()
{

}

void TabDictionaryNew::AddControls()
{
...
void TabDictionaryNew::SetUiTexts()
{
